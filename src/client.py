...
class LLMUsage:
    ...
    @staticmethod
    def from_metadata(metadata: dict, duration: float) -> "LLMUsage":
        if metadata is None:
            metadata = {}
        return LLMUsage(
            duration=duration,
    ...
    def from_dict(data: dict):
        return LLMUsage(
            ...
            num_token_in=data.get("num_token_in", 0),
            num_token_out=data.get("num_token_out", 0),
        )
    ...
    def to_dict(self):
        return {
            ...
            "num_token_in": self.num_token_in,
            "num_token_out": self.num_token_out,
        }
